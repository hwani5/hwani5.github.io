...
// Countdown
$('#clock').countdown('2016/9/31').on('update.countdown', function(event) {
...
// 한글을 적용하려면 아래 코드를 사용한다. %!w, %!d는 복수(s)를 표현하는데 사용하는 거 같음
//         + '<div><span>%-w</span>주</div>'
//         + '<div><span>%-d</span>일</div>'
//         + '<div><span>%H</span>시</div>'
//         + '<div><span>%M</span>분</div>'
//         + '<div><span>%S</span>초</div>'));
     });
